...
from numbast.types import register_enum_type, to_numba_type
...
def bind_cxx_enum(e: pylibastcanopy.Enum):
    ...
    underlying_integer_type = to_numba_type(e.underlying_type.name)
    ...
    register_enum_type(e.name, pyenum, underlying_integer_type)
